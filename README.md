...
> **Sample on GitHub** · `USDCAD_1m.csv` (55,440 rows, `2026-07-09` -> `2026-09-02`, 5.27 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/usdcad)** — **9,146,902** `1m` rows, **11 timeframes**, `2001-11-28` -> `2026-09-02`.
